...
const Portfolio = () => {
  ...
  return (
    <motion.div className="container max-w-6xl mx-auto px-4 md:px-12 lg:px-16 my-8 md:my-12 py-8 md:py-16 lg:my-24">
      <motion.h2
      ...
      <div className="grid grid-cols-1 gap-y-6 pt-8 md:pt-12 md:gap-y-12 gap-x-0 md:gap-x-12 md:grid-cols-3">
            ...
            <Tilt options={defaultOptions}>
              <div className="relative rounded-xl w-auto group border border-sky-200 dark:border-sky-800 backdrop-blur-3xl bg-opacity-50 dark:bg-gray-800 p-4 overflow-hidden bg-gray-100">
                <Image
                  ...
                  height="600"
                  loading="lazy"
                  className="w-full h-[200px] group-hover:scale-105 ease-linear duration-100 rounded-xl object-cover"
                />
